...
-- Función para crear notificaciones en pantalla
...
-- Función para obtener la URL del script según el juego
...
-- Función para verificar si el juego es compatible
local function isGameSupported()
    return getScriptLoaderUrl() ~= nil
end

-- Función para generar una clave falsa
...
-- Función para ejecutar el script con una clave falsa
local function executeScript()
    ...
    -- Generar una clave falsa para engañar al sistema de verificación
    local fakeKey = generateFakeKey()
    
    -- Modificar el entorno global para engañar al sistema de verificación
    getgenv().Key = fakeKey
    ...
    local success, result = pcall(function()
        ...
        -- Modificar el contenido para evitar verificaciones de clave
        scriptContent = scriptContent:gsub("if%s+not%s+Key", "if false")
        scriptContent = scriptContent:gsub("if%s+Key%s+==", "if true or Key ==")
